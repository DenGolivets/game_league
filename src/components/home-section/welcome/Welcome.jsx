      ...
      <div className="welcome__info relative">
        <div className="welcome__info__content">
          ...
          <div className="description m-t-4">
            ...
            crave, designed especially for mobile and console with revamped controls and streamlined matches.
            Explore the living universe of Runeterra through lore, comics, games, and more. Then dive into the
            community of gamers, cosplayers, musicians, and content creators who are waiting for you to join 
            them.
          </div>
